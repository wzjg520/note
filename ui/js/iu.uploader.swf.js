...
SWFUpload.prototype.initSWFUpload = function (settings) {
	try {
		...
		this.eventQueue = [];
		this.movieName = "iu_uploader_swf_" + SWFUpload.movieCount++;
...
SWFUpload.prototype.initSettings = function () {
	...
	// Flash Settings
	this.ensureDefault("flash_url", "iu.uploader.swf");
	...
	if (this.settings.prevent_swf_caching) {
		this.settings.flash_url = this.settings.flash_url + "?_t=" + Math.floor(Math.random() * 999999999);
	}
...
SWFUpload.prototype.getFlashHTML = function () {
	...
	return ['<object id="', this.movieName, '" class="iu_uploader_swf" style="position:relative;cursor:pointer" type="application/x-shockwave-flash" data="', this.settings.flash_url, '" width="', this.settings.button_width, '" height="', this.settings.button_height, '">',
